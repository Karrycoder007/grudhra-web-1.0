  ...
  return (
    <div className="bg-gray-100 dark:bg-black min-h-screen">
      ...
      className="bg-gradient-to-b from-black to-[#001E80] text-transparent bg-clip-text dark:from-white to-[#1f3b95] p-4 text-center">
        ...
        <p className="mt-5 para dark:text-gray-400">Innovative Solutions for a Sustainable Future</p>
      </motion.header>
        ...
        <div className="flex flex-col  items-center justify-around">
          ...
          transition={{duration:0.8}}
           className="max-w-6xl text-center px-10">
            <h2 className="text-4xl flex justify-center font-semibold text-gray-500 dark:text-gray-400 mb-4">About Us</h2>
      ...
      <section className="mt-10 bg-white dark:bg-black p-6 rounded-lg shadow-lg">
        <h2 className="text-6xl font-semibold bg-gradient-to-b from-black to-[#001E80] text-transparent bg-clip-text  dark:from-white to-[#1f3b95] text-center pb-10 heading-2">Our Services</h2>
        <motion.div
        whileInView={{opacity:1,y:0}}
        initial={{opacity:0,y:100}}
        transition={{duration:0.8}}
         className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {[
            ...
            <div key={index} className="p-4 bg-gray-100 dark:bg-gray-500 rounded-lg shadow-md">
              <img src={service.image} alt={service.title} className="w-full h-48 object-cover mb-4 rounded-lg"/>
              <h3 className="text-xl font-bold text-gray-800 dark:text-gray-300 mb-2">{service.title}</h3>
      ...
      <section className="mt-10 p-6">
        ...
        className="bg-gradient-to-b from-gray-700 to-[#1b327b] bg-clip-text text-transparent p-6 rounded-lg text-center">
          ...
          transition={{duration:1.2}}
           className="text-5xl font-semibold mb-4 heading-2 bg-gradient-to-b from-black to-[#001E80] text-transparent bg-clip-text  dark:from-white to-[#1f3b95]">Our Story</motion.h2>
          <motion.p
          whileInView={{opacity:1,y:0}}
          initial={{opacity:0,y:100}}
          transition={{duration:0.8}}
