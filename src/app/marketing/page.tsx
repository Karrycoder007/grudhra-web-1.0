...
const page = () => {
  ...
  return (
    <div className="container mx-auto  bg-gray-300 dark:bg-black">
      ...
      <h2 className="text-5xl font-semibold text-gray-700 dark:text-gray-300 mb-4">Why Choose Grudhra Marketing?</h2>
      ...
      className="px-10 mt-16 bg-gray-300 dark:bg-black">
        <h2 className="text-4xl font-semibold text-gray-700 dark:text-gray-300 text-center pb-14 heading-2">Our Expertise</h2>
        <motion.div
         whileInView={{ opacity: 1, y: 0 }}
         initial={{ opacity: 0, y: 100 }}
